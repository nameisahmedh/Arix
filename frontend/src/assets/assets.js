...
export const AiToolsData = [
  {
    ...
    description: 'Craft SEO-friendly, engaging long-form content in seconds using AI.',
    Icon: MessageSquareText,
    bg: { from: '#FB6D3A', to: '#FF8C5A' },
    path: '/ai/write-article'
  },
  {
    title: 'Catchy Blog Title Maker',
    description: 'Generate attention-grabbing blog titles tailored to your content.',
    Icon: Type,
    bg: { from: '#B23BE0', to: '#FF5DA9' },
    path: '/ai/blog-titles'
  },
  {
    title: 'AI Image Generator',
    description: 'Transform your ideas into stunning visuals using generative AI.',
    Icon: ImagePlus,
    bg: { from: '#20B486', to: '#00B7C2' },
    path: '/ai/generate-images'
  },
  {
    title: 'Auto Background Remover',
    description: 'Remove backgrounds from images with one click—fast and accurate.',
    Icon: Sparkles,
    bg: { from: '#F76C1C', to: '#FB6D3A' },
...
export const dummyPublishedCreationData = [
    {
        "id": 1,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "A mischievous fox in a hoodie with a cheeky grin.",
        "content": ai_gen_img_1, // This now correctly refers to the imported image
        "type": "image",
        "publish": true,
        "likes": [
        ...
        "author": {
            "name": "FoxWithHoodie",
            "avatarUrl": "https://i.pravatar.cc/150?u=user_2yMX02PRbyMtQK6PebpjnxvRNIA"
        }
    },
    {
        "id": 2,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "A cheerful round robot with glowing blue eyes.",
        "content": ai_gen_img_2, // This now correctly refers to the imported image
        "type": "image",
        "publish": true,
        "likes": [
            "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
    ...
    },
    {
        ...
        "prompt": "A cool skateboarder kid in colorful streetwear.",
        "content": ai_gen_img_3, // This now correctly refers to the imported image
        "type": "image",
        "publish": true,
        "likes": [
            "user_2yaW5EHzeDfQbXdAJWYFnZo2bje"
        ...
        "author": {
            "name": "SkyDriver",
            "avatarUrl": "https://i.pravatar.cc/150?u=user_2yaW5EHzeDfQbXdAJWYFnZo2bje"
        }
    },
];